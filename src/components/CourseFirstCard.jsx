...
export default function CourseFirstCard({ courseId, name, requirement, duration, fees, date }) {
      ...
      <CustomCard className="item commonCard">
        ...
        <Box className="cardContent">
          ...
          <Box className="commentSection">
            ...
            <ul>
              <li>
                <CommonBtn type="submit" variant="contained" onClick={() => navigate(`/course/${courseId}`)}>
                  Apply Course
                </CommonBtn>
              </li>
            </ul>
